...
public class UnreliableRobotTest extends UnreliableRobot{
	...
	public void setUp() {
		...
		robot = new UnreliableRobot(controller,'1','1','1','1');	
	...
	/**
	 * Test case: Check if the left sensor is an unreliable sensor 
	 * <p>
	 * Method under test:startFailureAndRepairProcess(Direction.LEFT, 4000, 2000);
	 * <p>
	 * Correct behavior: The left sensor shoold not work for the first 2 seconds and then work for the next 4 seconds 
	 * 
	 */
	@Test
	public final void testLeftSensorUnreliable() throws Exception {  
		robot = new UnreliableRobot(controller,'1','0','1','1');	
		controller.setRobotAndDriver(robot, wallfollower);	
		robot.setController(controller);
		robot.startFailureAndRepairProcess(Direction.LEFT, 4000, 2000);
		assertEquals(robot.distanceToObstacle(Direction.LEFT),-1);
		Thread.sleep(2000);
	...
	/**
	 * Test case: Check if the right sensor is an unreliable sensor 
	 * <p>
	 * Method under test:startFailureAndRepairProcess(Direction.RIGHT, 4000, 2000);
	 * <p>
	 * Correct behavior: The right sensor should not work for the first 2 seconds and then work for the next 4 seconds 
	 * 
	 */
	@Test
	public final void testRightSensorUnreliable() throws Exception {  
		robot = new UnreliableRobot(controller,'1','1','0','1');	
		controller.setRobotAndDriver(robot, wallfollower);	
		robot.setController(controller);
		robot.startFailureAndRepairProcess(Direction.RIGHT, 4000, 2000);
		assertEquals(robot.distanceToObstacle(Direction.RIGHT),-1);
		Thread.sleep(2000);
	...
	/**
	 * Test case: Check if the forward sensor is an unreliable sensor 
	 * <p>
	 * Method under test:startFailureAndRepairProcess(Direction.FORWARD, 4000, 2000);
	 * <p>
	 * Correct behavior: The forward sensor should not work for the first 2 seconds and then work for the next 4 seconds 
	 * 
	 */
	@Test
	public final void testForwardSensorUnreliable() throws Exception {  
		robot = new UnreliableRobot(controller,'0','1','1','1');	
		controller.setRobotAndDriver(robot, wallfollower);	
		robot.setController(controller);
		robot.startFailureAndRepairProcess(Direction.FORWARD, 4000, 2000);
		assertEquals(robot.distanceToObstacle(Direction.FORWARD),-1);
		Thread.sleep(2000);
	...
	/**
	 * Test case: Check if the backward sensor is an unreliable sensor 
	 * <p>
	 * Method under test:startFailureAndRepairProcess(Direction.backward, 4000, 2000);
	 * <p>
	 * Correct behavior: The backward sensor should not work for the first 2 seconds and then work for the next 4 seconds 
	 * 
	 */
	@Test
	public final void testBackwardSensorUnreliable() throws Exception {  
		robot = new UnreliableRobot(controller,'1','1','1','0');	
		controller.setRobotAndDriver(robot, wallfollower);	
		robot.setController(controller);
		robot.startFailureAndRepairProcess(Direction.BACKWARD, 4000, 2000);
		assertEquals(robot.distanceToObstacle(Direction.BACKWARD),-1);
		Thread.sleep(2000);
	...
	/**
	 * Test case: Check if two sensors are unreliable 
	 * <p>
	 * Method under test:startFailureAndRepairProcess(Direction.backward, 4000, 2000);
	 * <p>
	 * Correct behavior: The backward sensor and the right sensor should work and repair independently 
	 * 
	 */
	@Test
	public final void testTwoSensorsUnreliable() throws Exception {  
		robot = new UnreliableRobot(controller,'1','1','0','0');	
		controller.setRobotAndDriver(robot, wallfollower);	
		robot.setController(controller);
		robot.startFailureAndRepairProcess(Direction.BACKWARD, 4000, 2000);
		assertEquals(robot.distanceToObstacle(Direction.RIGHT),0);
	 ...
	 * Method under test:startFailureAndRepairProcess(Direction.backward, 4000, 2000);
	 * <p>
	 * Correct behavior: The forward sensor and the left sensor should work and repair independently  
	 * 
	 */
	@Test
	public final void testTwoSensorsLeftForwardUnreliable() throws Exception {  
		robot = new UnreliableRobot(controller,'0','0','1','1');	
		controller.setRobotAndDriver(robot, wallfollower);	
		robot.setController(controller);
		robot.startFailureAndRepairProcess(Direction.FORWARD, 4000, 2000);
		assertEquals(robot.distanceToObstacle(Direction.FORWARD),11);
	 ...
	 */
	@Test
	public final void testTwoSensorsLeftRightUnreliable() throws Exception {  
		robot = new UnreliableRobot(controller,'1','0','0','1');	
		controller.setRobotAndDriver(robot, wallfollower);	
		robot.setController(controller);
		robot.startFailureAndRepairProcess(Direction.LEFT, 4000, 2000);
		assertEquals(robot.distanceToObstacle(Direction.LEFT),0);
