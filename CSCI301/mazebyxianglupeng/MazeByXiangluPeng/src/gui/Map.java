...
//		Graphics g = panel.getBufferGraphics() ;
	...
	private void drawMap(MazePanel panel, int px, int py, int walkStep, 
		...
		panel.setColor(MazePanel.white.getRGB());
		...
		for (int y = minY; y <= maxY; y++)
			for (int x = minX; x <= maxX; x++) {
				...
				panel.setColor(seenWalls.hasWall(x,y, CardinalDirection.North) ? MazePanel.white.getRGB() : MazePanel.gray.getRGB());
				...
				panel.setColor(seenWalls.hasWall(x,y, CardinalDirection.West) ? MazePanel.white.getRGB() : MazePanel.gray.getRGB());
	...
	private void drawCurrentLocation(MazePanel panel, int viewDX, int viewDY) {
		panel.setColor(MazePanel.red.getRGB());
	...
	private void drawSolution(MazePanel panel, int offsetX, int offsetY, int px, int py) {
		...
		panel.setColor(MazePanel.yellow.getRGB());
